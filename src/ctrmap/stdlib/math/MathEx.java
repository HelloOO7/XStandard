...
public class MathEx {
	 ...
	 * @param adj2 The second side of the triangle that is adjacent to the
	 * angle.
	...
	/**
	 * Returns the cosine of an angle in a triangle calculated using the law of
	 * cosines.
	 *
	 * @param adj1 The first side of the triangle that is adjacent to the angle.
	 * @param adj2 The second side of the triangle that is adjacent to the
	...
	/**
	 * Calculates an angle of a triangle using the law of sines, knowing the
	 * side opposite to it and an arbitrary other side/angle pair.
	 *
	...
	/**
	 * Calculates the sine of an angle of a triangle using the law of sines, knowing the
	 * side opposite to it and an arbitrary other side/angle pair.
	 *
	 * @param side1 A side of the triangle that is not opposite to the angle to be calculated.
	 * @param angle1 The angle opposite to side1.
